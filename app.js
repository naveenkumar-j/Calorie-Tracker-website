...
const UICtrl = (function(){
    const UISelectors = {
        ...
        totalCaloriesInput: '#item-calories',
    ...
    return {
        ...
        addListItem: function(item){
            ...
            // Add ID
            li.id = `item-${item.id}`;
            li.innerHTML = `<strong>${item.name}: </strong> ${item.calories} Calories 
            <a href="" class="secondary-content">
             <i class="edit-item far fa-edit"></i>
            </a>`;
        ...
        updateListItem: function(item){
            ...
            listItems.forEach(function(listItem){
                ...
                if(itemID === `item-${item.id}`){
                    document.querySelector(`#${itemID}`).innerHTML =`<strong>${item.name}: </strong> ${item.calories} Calories 
                    <a href="" class="secondary-content">
                     <i class="edit-item far fa-edit"></i>
                    </a>`;
                }
...
const App = (function(ItemCtrl, StorageCtrl, UICtrl){
    ...
    const loadEventListeners = function(){
        ...
        // Updated item event
        document.querySelector(UISelectors.uptadeBtn).addEventListener('click',
        itemUpdateSubmit);
